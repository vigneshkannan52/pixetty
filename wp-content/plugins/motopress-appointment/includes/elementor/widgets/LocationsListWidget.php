<?php
/**
 * Class: LocationsListWidget
 * Name: Locations List
 * Slug: mpa-locations-list
 */
...
class LocationsListWidget extends AbstractAppointmentWidget {


	public function get_name() {

		return 'mpa-locations-list';
	}
	...
	protected function render() {
		...
		echo mpa_shortcodes()->locationsList()->render( $attributes );
	}
}
