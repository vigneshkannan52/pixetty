<?php
/**
 * Class: EmployeeAdditionalInfoWidget
 * Name: Employee Additional Information
 * Slug: mpa-employee-additional-info
 */
...
class EmployeeAdditionalInfoWidget extends AbstractAppointmentWidget {


	public function get_name() {
		return 'mpa-employee-additional-info';
	}
	...
	protected function render() {
		...
		echo mpa_shortcodes()->employeeAdditionalInfo()->render( $attributes );
	}
}
