<?php
/**
 * Class: EmployeeTitleWidget
 * Name: Employee Title
 * Slug: mpa-employee-title
 */
...
class EmployeeTitleWidget extends AbstractAppointmentWidget {


	public function get_name() {

		return 'mpa-employee-title';
	}
	...
	protected function render() {
		...
		echo mpa_shortcodes()->employeeTitle()->render( $attributes );
	}
}
