<?php
/**
 * Class: EmployeeImageWidget
 * Name: Employee Image
 * Slug: mpa-employee-image
 */
...
class EmployeeImageWidget extends AbstractAppointmentWidget {


	public function get_name() {
		return 'mpa-employee-image';
	}
	...
	protected function render() {
		...
		echo mpa_shortcodes()->employeeImage()->render( $attributes );
	}
}
