<?php
/**
 * Class: EmployeeServicesListWidget
 * Name: Employee Services List
 * Slug: mpa-employee-services-list
 */
...
class EmployeeServicesListWidget extends AbstractAppointmentWidget {


	public function get_name() {
		return 'mpa-employee-services-list';
	}
	...
	protected function render() {
		...
		echo mpa_shortcodes()->employeeServiceList()->render( $attributes );
	}
}
