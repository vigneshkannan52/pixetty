...
class EmployeeServicesListModule extends ET_Builder_Module {

	public $slug       = 'mpa_employee_services_list';
	...
	public function init() {
		...
		$this->name = esc_html__( 'Employee Services List', 'motopress-appointment' );
	}
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		return mpa_shortcodes()->employeeServiceList()->render( $args, $content );
	}
}
