...
class EmployeeSocialNetworksModule extends ET_Builder_Module {

	public $slug       = 'mpa_employee_social_networks';
	...
	public function init() {
		...
		$this->name = esc_html__( 'Employee Social Networks', 'motopress-appointment' );
	}
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		return mpa_shortcodes()->employeeSocialNetworks()->render( $args, $content );
	}
}
