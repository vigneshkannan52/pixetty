...
class EmployeeContentModule extends ET_Builder_Module {

	public $slug       = 'mpa_employee_content';
	...
	public function init() {
		...
		$this->name = esc_html__( 'Employee Content', 'motopress-appointment' );
	}
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		return mpa_shortcodes()->employeeContent()->render( $args, $content );
	}
}
