...
class EmployeesListModule extends AbstractShortcodeModule {

	public $slug       = 'mpa_employees_list';
	...
	public function init() {
		...
		$this->name = esc_html__( 'Employees List', 'motopress-appointment' );
	}
	...
	protected function getMPAShortcode(): Shortcodes\AbstractShortcode {
		return mpa_shortcodes()->employeesList();
	}
}
