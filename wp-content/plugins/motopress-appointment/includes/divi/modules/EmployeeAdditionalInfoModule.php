...
class EmployeeAdditionalInfoModule extends ET_Builder_Module {

	public $slug       = 'mpa_employee_additional_info';
	...
	public function init() {
		...
		$this->name = esc_html__( 'Employee Additional Information', 'motopress-appointment' );
	}
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		return mpa_shortcodes()->employeeAdditionalInfo()->render( $args, $content );
	}
}
